package com.lamar.primebox.notification.constant;

public class PrimeBoxEmailConstants {

    public static final String EMAIL_FROM = "lazarmarinkovic29@gmail.com";
    public static final String EMAIL_FROM_NAME = "PRIME BOX";
